...
(defgen2 gbd 'bd (load-sample (clojure.java.io/resource "kick.wav"))
 (frankentone.ugens/sine (- Math/PI) (flerp x TAU Math/PI)))

(defgen2 gsn 'sn (load-sample (clojure.java.io/resource "snare-chili.wav")) 
	(+ (frankentone.ugens/pink-c) (frankentone.ugens/bpf-c -0.32626803834574947 Math/PI (min 4.692821647267513 197.64356934620585))))

(defgen2 gvl 'vl (load-sample 	"/Users/hb/Desktop/nasty-violin-4.wav") 
